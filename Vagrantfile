...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "gporras-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/gporras-training"
  #   chef.validation_client_name = "gporras-training-validator"
  #   chef.validation_key_path = ".chef/gporras-training-validator.pem"
  # end
end
